...
import com.gomes.custodio.musicstorage.adapter.output.persistence.postgree.entity.toMusicEntity
...
class MusicPersistence(
    ...
    override fun save(musicDomain: MusicDomain): MusicDomain {
        return musicRepository.save<MusicEntity?>(musicDomain.toMusicEntity()).toMusicDomain()
    }
}